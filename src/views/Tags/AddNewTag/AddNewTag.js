...
const AddNewTag = () => {
  ...
  const handleAdd = async (e) => {
    ...
    let data = {
      ...
      is_category: 0, category_id: category
    }
    if (category === "not") {
      data = {
        name: { ar: name_ar, en: name_en },
    ...
    try {
      ...
      if (response.message && response.message == "Success") {
        setSuccessAdd(i18n.language === "ar" ? "تم اضافة وسم بنجاح" : "Tag has been added successfully")
        setUpData({
          name_ar: '',
          name_en: '',
        })
          ...
          <CCardHeader>
            <CRow className=" row-gap-15">
              <CCol md="6" lg="6" xl="6" className="justify-content-center align-self-center align-items-center place-items-center text-capitalize">
                <strong>{i18n.language == "ar" ? "اضافة وسم جديد" : "Add New Tag"}  </strong>
              </CCol>
