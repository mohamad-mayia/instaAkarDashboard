...
const TagUpdate = ({ match }) => {
    ...
    const getItem = async (id) => {
      ...
      try {
        const responsee = await fetch(
          `${global.apiUrl}api/categories?is_category=0`,
          {
            method: "GET",
            headers: {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const responsee = await fetch(
        `${global.apiUrl}api/categories/${match.params.id}?_method=put`,
        {
          method: "POST",
          headers: {
            Authorization: "Bearer " + userToken,
      ...
      if (response.message && response.message == "Success") {
        setSuccessAdd(i18n.language === "ar" ? "تم تعديل وسم بنجاح" : "Tag has been Updated successfully")
        setRefresh(!refresh)
          ...
          <CCardHeader>
            <CRow className=" row-gap-15">
              ...
              <CCol md="6" lg="6" xl="6" className="justify-content-center align-self-center align-items-center place-items-center text-capitalize">
                <strong>{i18n.language === "ar" ? "تعديل وسم" : "Update Tag"} </strong>
              </CCol>
                  ...
                  <CCard>
                    <CCardBody>
                      <CRow >
                        ...
                        <CCol md='12'> <strong> {i18n.language == "ar" ? "معلومات الوسم" : "Tag Information"}</strong></CCol>
                        <CCol md="6" lg="6" xl="6">
                          <CFormGroup row>
                            <CCol md="12">
