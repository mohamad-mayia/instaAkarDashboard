...
const UpdatePriority = ({match}) => {
  ...
  const handleAddPriority = async (e) => {
    ...
    color
      ...
      if (response.success) {
        await setVisible(6)
        setSuccessAdd(i18n.language == 'ar' ? "تم تعديل أولوية بنجاح" : "Ticket Priority Updated Successfuly")
setRefresh(!refresh)
      }
      else {
          ...
          <CCardHeader>
            <CRow className=" row-gap-15">
              ...
              <CCol md="6" lg="6" xl="6" className="justify-content-center align-self-center align-items-center place-items-center text-capitalize">
                <strong>{i18n.language == 'ar' ? "تعديل أولوية بطاقة" : "Update Ticket Priority"}</strong>
              </CCol>
