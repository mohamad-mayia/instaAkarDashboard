    ...
    <CRow>
            ...
            <CCardHeader>
              <CRow className=" row-gap-15">
                <CCol md="6" lg="6" xl="6" className="justify-content-center align-self-center align-items-center place-items-center text-capitalize">
                  {i18n.language === "ar" ? "أنوع العقارات" : "Property Types"}
                </CCol>

                <CCol md="6" lg="6" xl="6" className='row-gap-15 col-gap-15'>

                  <CButton color="success" className='col-lg-6  col-md-6 col-sm-12 col-xs-12 updatebtn'
                    onClick={() => history.push('/PropertyTypes/AddNewPropertyType')} >
                    {i18n.language === "ar" ? "إضافة نوع جديد" : "Add New Property Type"}
                    ...
                    (item) => (
                      <td>
                        ...
                        <CBadge className="p-1  m-1 badg-click" color="info"
                          onClick={() => history.push(`/PropertyTypes/Update/${item.id}`)}  >
                          {t("Update")}  </CBadge>
      ...
      <CModal
        ...
        <CModalHeader closeButton>
          <CModalTitle>{i18n.language === "ar" ? "حذف نوع" : "Delete Property Type"} </CModalTitle>
        </CModalHeader>
        <CModalBody>
          {`${i18n.language === "ar" ? "هل انت متأكد من حذف نوع" : "Are you sure you want to delete the property type"}   (${itemToDelete.name && itemToDelete.name[i18n.language]})`}
