...
import './AddNewPropertyType.scss'
  ...
  const handleAdd = async (e) => {
    ...
    try {
      ...
      if (response.message && response.message == "Success") {
        ...
        setSuccessAdd(i18n.language === "ar" ? "تم اضافة نوع بنجاح" : "Property Type has been added successfully")
        setUpData({
          name_ar: '',
          name_en: '',
        })
          ...
          <CCardHeader>
            <CRow className=" row-gap-15">
              <CCol md="6" lg="6" xl="6" className="justify-content-center align-self-center align-items-center place-items-center text-capitalize">
                <strong>{i18n.language == "ar" ? "اضافة نوع جديد" : "Add New Property Type"}  </strong>
              </CCol>
                  ...
                  <CCard>
                    <CCardBody>
                      <CRow >
                        ...
                        <CCol md='12'> <strong>{i18n.language == "ar" ? "معلومات النوع" : "Property Type Information"}</strong></CCol>
                        <CCol md="6" lg="6" xl="6">
                          <CFormGroup row>
                            <CCol md="12">
...
export default AddNewPropertyType
