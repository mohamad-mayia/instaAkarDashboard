...
if(activeUser.id){
  ...
  try {
    ...
    if(response.success){
      ...
      setSuccessAdd(i18n.language == 'ar' ? "تمت اضافة الموظف الى القسم بنجاح" 
      ...
      {pageStatus==0&&
       ...
       <CCard>
         ...
         <CRow className="justify-content-center row-gap-15 ">
            ...
            {i18n.language == 'ar' ? "الموظفون" : "Employees"}
            </CCol>
            <CCol md="6" lg="6" xl="6" className=" row-gap-15 col-gap-15 ">
            <CButton color="success"  className='col-lg-6  col-md-6 col-sm-12 col-xs-12 updatebtn'
           onClick={()=>history.push('/Admin/Employees/AddNewEmployee')} >
             {i18n.language == 'ar' ? "إضافة موظف جديد" : "Add New Employee"}
                  </CButton>
      ...
      }
      {
        ...
        <CCard>
          ...
          <CRow className="justify-content-center row-gap-15 ">
           ...
           onClick={()=>history.push(`/Admin/Employees/Update/${activeUser.id}`)} >{i18n.language == 'ar' ? `تعديل` : `Update`}
                  </CButton>
        ...
        {/* <CCard>
          ...
          <CRow className="">
            ...
            <CCol md="6" lg="6" xl="6" >
           <strong>{i18n.language == 'ar' ? `إضافة إلى قسم` : `Add To Department`}</strong>
            </CCol>
...
{ !activeUser.extension_number&& <CCol md="4" lg="4" xl="4">
           ...
           >{i18n.language == 'ar' ? `إضافة` : `Add`}  {loading&&<>{' '}<i className="fa fa-spinner fa-spin" ></i></>}
          ...
          */}
          <CRow>
            <CCol md='12'><strong>{i18n.language == 'ar' ? `الملف الشخصي` : `Profile`}</strong></CCol>
      <CCol lg={6}>
              <table className="table table-striped table-hover">
                <tbody>
                        ...
                        <tr >
                          <td>{i18n.language == 'ar' ? `الدور` : `Role`}</td>
                          <td><strong>{activeUser.user_roles[0]}</strong></td>
                        </tr>
                        <tr >
                          <td>{i18n.language == 'ar' ? `الاسم` : `Name`}</td>
                          <td><strong>{activeUser.name}</strong></td>
                        </tr>
                        <tr >
                          <td>{i18n.language == 'ar' ? `اسم المستخدم` : `User Name`}</td>
                          <td><strong>{activeUser.username}</strong></td>
                        </tr>
                       
                        <tr >
                          <td>{i18n.language == 'ar' ? `الموقع الوظيفي` : `Position`}</td>
              ...
              <table className="table table-striped table-hover">
                <tbody>
                        ...
                        <tr >
                          <td>{i18n.language == 'ar' ? `البريد الالكتروني` : `Email`}</td>
                        ...
                        <tr >
                          <td>{i18n.language == 'ar' ? `اللغة` : `Language`}</td>
                          <td><strong>{activeUser.locale}</strong></td>
                        </tr>
                        <tr >
                          <td>{i18n.language == 'ar' ? `الحالة` : `Status`}</td>
                          <td><strong>{activeUser.active==1?
                          <>
                          {i18n.language == 'ar' ? `فعال` : `Active`}
                          </>:
                           <>
                           {i18n.language == 'ar' ? `غير فعال` : 'Deactive'}
                           </>}</strong></td>
                        </tr>
