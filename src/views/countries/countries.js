    ...
    <CRow>
              ...
              <CRow className=" row-gap-15">
                ...
                <CCol md="6" lg="6" xl="6" className='row-gap-15 col-gap-15'>
                  ...
                  <CButton color="success" className='col-lg-6  col-md-6 col-sm-12 col-xs-12 updatebtn'
                    ...
                    {i18n.language === "ar" ? "إضافة دولة جديد" : "Add new Country"}
            ...
            <CCardBody className='usersTabel'>
              {data && <CDataTable
                ...
                fields={['id',
                  ...
                  { label: i18n.language === "ar" ? "العملة بالعربية" : "Currency Ar", key: 'currency_ar' },
                  { label: i18n.language === "ar" ? "العملة بالانكليزية" : "Currency En", key: 'currency_en' },
      ...
      <CModal
        ...
        <CModalHeader closeButton>
          <CModalTitle>{i18n.language === "ar" ? "حذف دولة" : "Delete Country"} </CModalTitle>
        </CModalHeader>
        <CModalBody>
          {`${i18n.language === "ar" ? "هل انت متأكد من حذف دولة" : "Are you sure you want to delete the country"}   (${itemToDelete.name && itemToDelete.name[i18n.language]})`}
        </CModalBody>
        <CModalFooter>
