...
const AddNewStatus = () => {
  ...
  const handleAddStatus = async (e) => {
    ...
    try {
      const responsee = await fetch(
        `${global.apiUrl}/super/ticketStatuses`,
        {
          method: "POST",
          headers: {
            Authorization: "Bearer " + userToken,
      ...
      if (response.success) {
        await setVisible(6)
        setSuccessAdd(i18n.language == 'ar' ? "تمت اضافة حالة بنجاح" : "New Ticket Status Added Successfuly")
          ...
          <CCardHeader>
            <CRow className=" row-gap-15">
              ...
              <CCol md="6" lg="6" xl="6" className="justify-content-center align-self-center align-items-center place-items-center text-capitalize">
                <strong>{i18n.language == 'ar' ? "إضافة حالة بطاقة جديدة" : "Add New Ticket Status"}</strong>
              </CCol>
         ...
         onClick={()=>history.goBack()} >{i18n.language == 'ar' ? `رجوع` : `Back`}
          ...
          <CRow>
            <CCol xs="12" sm="12" md="12" className=''>
              <CForm onSubmit={(e) => { handleAddStatus(e) }}>
                <CCardBody>
                  <CCard>
                    <CCardBody>
                      <CRow >
                        ...
                        <CCol md='12'> <strong>{i18n.language == 'ar' ? `معلومات الحالة الجديدة :` : `New Status Informations :`}</strong></CCol>
                        <CCol md="6" lg="6" xl="6">
                          <CFormGroup row>
                            <CCol md="12">
