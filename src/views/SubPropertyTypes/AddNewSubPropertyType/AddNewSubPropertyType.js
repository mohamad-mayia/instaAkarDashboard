...
import './AddNewSubPropertyType.scss'
...
const AddNewSubPropertyType = () => {
  ...
  const handleAdd = async (e) => {
    ...
    try {
      ...
      if (response.message && response.message == "Success") {
        setSuccessAdd(i18n.language === "ar" ? "تم اضافة نوع فرعي بنجاح" : "Sub Property Type has been added successfully")
        setUpData({
          name_ar: '',
          name_en: '',
        })
          ...
          <CCardHeader>
            <CRow className=" row-gap-15">
              <CCol md="6" lg="6" xl="6" className="justify-content-center align-self-center align-items-center place-items-center text-capitalize">
                <strong>{i18n.language == "ar" ? "اضافة نوع فرعي جديد" : "Add New Sub Property Type"}  </strong>
              </CCol>
                      ...
                      <CRow >
                        ...
                        <CCol md="6"  >
                          <CFormGroup row>
                            ...
                            <CCol xs="12" md="12">
                              <CSelect custom name="category_id" required
                                value={type}
...
export default AddNewSubPropertyType
