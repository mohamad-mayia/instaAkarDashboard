...
const OfferTypeUpdate = ({ match }) => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      if (response.message && response.message == "Success") {
        setSuccessAdd(i18n.language === "ar" ? "تم تعديل نوع بنجاح" : "Type has been Updated successfully")
        setRefresh(!refresh)
          ...
          <CCardHeader>
            <CRow className=" row-gap-15">
              ...
              <CCol md="6" lg="6" xl="6" className="justify-content-center align-self-center align-items-center place-items-center text-capitalize">
                <strong>{i18n.language === "ar" ? "تعديل نوع عروض" : "Update Offer Type"} </strong>
              </CCol>
                  ...
                  <CCard>
                    <CCardBody>
                      <CRow >
                        ...
                        <CCol md='12'> <strong> {i18n.language == "ar" ? "معلومات النوع" : "Type Information"}</strong></CCol>
                        <CCol md="6" lg="6" xl="6">
                          <CFormGroup row>
                            <CCol md="12">
