...
useEffect(async()=>{
  ...
  if(response.message== "Website settings retrieved successfully!"){
   ...
   setDataText(response.payload.terms_and_conditions)
  }
...
dataText&& data.append('terms_and_conditions',dataText );
    ...
    <div className="c-app c-default-layout flex-row align-items-center register-cont">
     ...
     {pageStatus==0&&<>
      {fetchedData&&   <CCard>
          ...
          <CCardBody>
          <CRow>
          <CCol md='12' dangerouslySetInnerHTML={{__html: fetchedData.terms_and_conditions}} >
            {/* {toHtml()} */}
