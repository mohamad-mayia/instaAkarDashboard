...
useEffect(async()=>{
  ...
  if(response.message== "Website settings retrieved successfully!"){
   ...
   setPrivacyPolicy(response.payload.privacy_policy_ar)
  }
...
privacyPolicy&& data.append('privacy_policy_ar', privacyPolicy);
    ...
    <div className="c-app c-default-layout flex-row align-items-center register-cont">
     ...
     {pageStatus==0&&<>
      {fetchedData&&   <CCard>
          ...
          <CCardBody>
          <CRow>
          <CCol md='12' className='arbicJustfiy' dangerouslySetInnerHTML={{__html: fetchedData.privacy_policy_ar}} >
            {/* {toHtml()} */}
