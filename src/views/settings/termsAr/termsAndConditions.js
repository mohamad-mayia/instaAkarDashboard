...
dataText&& data.append('terms_and_conditions_ar',dataText );
    ...
    <div className="c-app c-default-layout flex-row align-items-center register-cont">
     ...
     {pageStatus==0&&<>
      {fetchedData&&   <CCard>
          ...
          <CCardBody>
          <CRow>
          <CCol md='12' className='arbicJustfiy' dangerouslySetInnerHTML={{__html: fetchedData.terms_and_conditions_ar}} >
            {/* {toHtml()} */}
